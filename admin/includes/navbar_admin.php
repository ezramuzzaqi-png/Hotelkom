  ...
  <nav id="sidebar">
    <ul>
      ...
      <li>
        ...
        <ul class="sub-menu">
            <div>
                <li><a href="hotels.php">Kelola hotels</a></li>
                <li><a href="rooms.php">Kelola rooms</a></li>
            </div>
        </ul>
      </li>
      <li>
        ...
        <ul class="sub-menu">
            <div>
                <li><a href="tambah-hotels.php">Kelola hotels</a></li>
                <li><a href="tambah-rooms.php">Kelola rooms</a></li>
            </div>
        </ul>
      </li>
      <li>
